<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminDashboard.aspx.cs" Inherits="Student_Portal.adminDashboard" %>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">            
            ...
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Operations</span></li>
              <li class="menu-item">
                  <a
                    href="Registerpage.aspx"
                    target="_blank"
                    class="menu-link">
                    <img src="Images/student.png" width="25" height="25"/>
                    <div data-i18n="Email">add Teacher</div>
                  </a>
                </li>
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary" style="margin-bottom:80px">Welcome Teacher</h5>

                          <a href="https://localhost:44331/teacherProfile.aspx" class="btn btn-sm btn-outline-primary">View Profile</a>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body" style="height:175px">
                          ...
                          <span class="fw-medium d-block mb-1">Students</span>
                          <h3 class="card-title mb-2">
                                <asp:Label ID="student" runat="server"></asp:Label>
                            </h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body"style="height:175px">
                          ...
                          <h3 class="card-title mb-2">
                                <asp:Label ID="professor" runat="server"></asp:Label>
                            </h3>
                        </div>
                      </div>
                    </div>
