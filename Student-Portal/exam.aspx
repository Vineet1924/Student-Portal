<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="exam.aspx.cs" Inherits="Student_Portal.exam" %>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">            
            <li class="menu-item">
              <asp:HyperLink
                runat="server"
                NavigateUrl="teacherDashboard.aspx"
                target="_blank"
                CssClass="menu-link">
          ...
          <asp:GridView ID="Students" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView_RowDataBound" CssClass="styled-table">
            <Columns>
                    ...
                    <asp:TemplateField HeaderText="Marks">
                        <ItemTemplate>
                            <asp:TextBox ID="txtMarks" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
