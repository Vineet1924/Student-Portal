<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hallTicket.aspx.cs" Inherits="Student_Portal.hallTicket" %>
  ...
  <body style="overflow:hidden">
    ...
    <div class="layout-wrapper layout-content-navbar">
     ...
     AutoPostBack="true" />
            ...
            <div style="padding:10px; height:530px; margin-top:-50px">
                <asp:GridView ID="SubjectsGridView" runat="server" AutoGenerateColumns="False" CssClass="styled-table">
    <Columns>
        <asp:TemplateField HeaderText="Subjects">
            <ItemTemplate>
                <asp:Label ID="lblSubjectName" runat="server" Text='<%# Container.DataItem %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Select Date">
            <ItemTemplate>
                <input type="date" name="examdate" id="examdate" class="datePicker" runat="server"/>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Room No">
            <ItemTemplate>
                <asp:TextBox ID="txtRoomNo" runat="server" CssClass="roomNoTextBox"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
