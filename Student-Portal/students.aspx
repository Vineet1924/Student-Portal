<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="students.aspx.cs" Inherits="Student_Portal.students" %>
  ...
  <body style="overflow:hidden">
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <form id="attandanceForm" runat="server">
        <div class="row">
            ...
            <div style="padding:18px">
                   <asp:Button
                        type="sub"
                        ID="btn_searchStudent"
                        runat="server"
                        Text="Search"
                        CssClass="btn btn-primary btn-block mb-4"
                        OnClick="btn_searchStudent_Click" 
                        AutoPostBack="true" />
      ...
      <div class="col-md-6 mb-4">
    <asp:DropDownList ID="sessionalDropdown" runat="server" CssClass="form-control">
        ...
        <div style="overflow-y:scroll; padding-right:8px; height:410px; padding-left:8px;" >
          <asp:GridView ID="Students" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView_RowDataBound" CssClass="styled-table">
            <Columns>
                    ...
                    <asp:TemplateField HeaderText="Lecture">
                        <ItemTemplate>
                            <asp:TextBox ID="txtLecture" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Lab">
                        <ItemTemplate>
                            <asp:TextBox ID="txtLab" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
