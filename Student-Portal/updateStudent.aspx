<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateStudent.aspx.cs" Inherits="Student_Portal.updateStudent" %>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-outline mb-4">
         ...
         <div style="padding-bottom:8px; margin-bottom:10px; width:1090px;">
    ...
    <script type="text/javascript">
        function setHiddenFieldValue(enrollmentNo, fname, lname, dob, email, phone) {
            ...
            document.getElementById('txt_firstname').value = fname;
            document.getElementById('txt_lastname').value = lname;
            document.getElementById('dateofbirth').value = dob;
            document.getElementById('txt_email').value = email;
            document.getElementById('txt_phone').value = phone;
        }

        function openModal(enrollmentNo, firstName, lastName, formattedDOB, email, phone) {
            setHiddenFieldValue(enrollmentNo, firstName, lastName, formattedDOB, email, phone);
            $('#exampleModalCenter').modal('show');
        }

        function clickButton() {
            document.getElementById('<%= btn_updateStudent.ClientID %>').click();
